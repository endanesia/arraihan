...
<div class="d-flex">
  <aside class="sidebar p-3">
    ...
    <ul class="nav flex-column gap-1">
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center justify-content-between <?= nav_active('/admin/hero') || nav_active('/admin/about') ? 'active' : '' ?>" 
        ...
        <ul class="nav flex-column ps-3 mt-1 submenu" id="homepage-menu" style="display: <?= nav_active('/admin/hero') || nav_active('/admin/about') ? 'block' : 'none' ?>;">
          <li class="nav-item">
