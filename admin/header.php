  ...
  <aside class="sidebar">
    ...
    <ul class="nav flex-column gap-1">
      ...
      <li class="nav-item">
        ...
        <ul class="nav flex-column submenu" id="homepage-menu" style="display: <?= nav_active('/admin/hero-slides') || nav_active('/admin/hero') || nav_active('/admin/greeting') || nav_active('/admin/keunggulan') || nav_active('/admin/about') || nav_active('/admin/mutawwif') || nav_active('/admin/popup-banner') || nav_active('/admin/hero-video') ? 'block' : 'none' ?>;">
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link <?= nav_active('/admin/hero-video') ?>" href="<?= e($base) ?>/admin/hero-video">
              <i class="fas fa-play-circle"></i>Hero Video
            </a>
          </li>
          <li class="nav-item">
